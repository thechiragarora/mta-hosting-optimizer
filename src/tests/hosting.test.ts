...
describe('Hosting', () => {
    ...
    describe('Hosting', () => {
        ...
        describe('Success Scenario', () => {
            ...
            it('Should get all the inefficient hostings with limit custom value used', async () => {
                const res = await request.get('/api/hosting/inefficient-hostings?limit=1');
                expect(res.status).toEqual(statusCodes.SUCCESS);
                expect(res.body.message).toEqual(codeMessages[statusCodes.SUCCESS]);
                expect(res.body.data.length).toEqual(1);
            });
            it('Should get all the inefficient hostings with skip custom value used', async () => {
            ...
            it('Should get HostingController instance', async () => {
                const instance = HostingController.getInstance();
                expect(instance).toBeInstanceOf(HostingController);
            });
            ...
            it('should get route not found error', async () => {
                const res = await request.get('/api/hostingsdf');
        ...
        describe('Failure Scenario', () => {
            ...
            it('should call server run without any configuration', async () => {
                await server.run();
            });
